    ...
    #                                   DISCLAIMER
    #================================================================================
    # This software is part of the TestFlow platform, developed and owned by ATOMS.
    #    All rights reserved. Unauthorized copying, modification, or distribution
    #   of this code, via any medium, is strictly prohibited without prior written
    #                             permission from ATOMS.
    #--------------------------------------------------------------------------------
    #                                www.atomsai.net
    #--------------------------------------------------------------------------------
    #                               © ATOMS | TestFlow
...
def run_script(script_path: str, output_path: str):
    ...
    ╚══██╔══╝██╔════╝██╔════╝╚══██╔══╝      ██╔════╝██║     ██╔═══██╗██║    ██║
       ...
       ╚═╝   ╚══════╝╚══════╝   ╚═╝         ╚═╝     ╚══════╝ ╚═════╝  ╚══╝╚══╝ 
        ...
        log_print_panner("This software is part of the TestFlow platform, developed and owned by ATOMS.".center(80))
        log_print_panner("All rights reserved. Unauthorized copying, modification, or distribution".center(80))
        log_print_panner("of this code, via any medium, is strictly prohibited without prior written".center(80))
        log_print_panner("permission from ATOMS.".center(80))
